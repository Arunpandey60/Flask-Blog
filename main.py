...
app = Flask(__name__)
app.config['SQLALCHEMY_DATABASE_URI'] = 'mysql://root:@localhost/codingthunders'
app.secret_key = 'super secret-key'
app.config['UPLOAD FOLDER'] = params['upload_loaction']
...
app.config['MAIL_PASS'] = "[params['gmail-pass']"  
